...
#David H. Wise, Robin M. Mores, Jennifer Pajda-De La O, Matthew A. McCary 
#April 3 2023
...
#=====import data======
#relative pathname
ig <- file.path(".", "Data", "Figs 4-7", "intraguild_predation.csv")
print(ig)
...
#=====import data======
#relative pathname
ig <- file.path(".", "Data", "Figs 4-7", "IGP-season-by-year.csv")
print(ig)
